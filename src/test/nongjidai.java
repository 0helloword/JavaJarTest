...
public class nongjidai {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.linkText("新增工单(农机贷)")).click();
	    new Select(driver.findElement(By.id("storeId"))).selectByVisibleText(args[3]);//选择店铺
	    Thread.sleep(1000);
	    new Select(driver.findElement(By.id("careerType"))).selectByVisibleText("农民");
	    Thread.sleep(1000);
	    new Select(driver.findElement(By.id("productSeriesId"))).selectByVisibleText(args[4]);//选择系列
	    Thread.sleep(1000);
	    new Select(driver.findElement(By.name("goodsReqs[0].cargoType"))).selectByVisibleText("农机");
	    Thread.sleep(1000);
	    new Select(driver.findElement(By.id("commodityClass_0"))).selectByVisibleText("机耕船");
	    Thread.sleep(1000);
	    driver.findElement(By.id("commodityName_0")).clear();
	    driver.findElement(By.id("commodityName_0")).sendKeys("1");
	    Thread.sleep(1000);
	    ...
	    String s5=ss1+Integer.toString(ss2+3)+"_"+Integer.toString(ss4+3);//第五个上传按键
	    String s6=ss1+Integer.toString(ss2+3)+"_"+Integer.toString(ss4+3);//第六个上传按键
	    String s7=ss1+Integer.toString(ss2+3)+"_"+Integer.toString(ss4+3);//第七个上传按键
	    String s8=ss1+Integer.toString(ss2+3)+"_"+Integer.toString(ss4+3);//第八个上传按键
	    String s9=ss1+Integer.toString(ss2+3)+"_"+Integer.toString(ss4+3);//第九个上传按键
	    ...
	    Thread.sleep(3000);
	    driver.findElement(By.id(s5)).sendKeys(args[9]); 
	    Thread.sleep(3000);
	    driver.findElement(By.id(s6)).sendKeys(args[9]); 
	    Thread.sleep(3000);
	    driver.findElement(By.id(s7)).sendKeys(args[9]); 
	    Thread.sleep(3000);
	    driver.findElement(By.id(s8)).sendKeys(args[9]); 
	    Thread.sleep(3000);
	    driver.findElement(By.id(s9)).sendKeys(args[9]); 
	    Thread.sleep(3000);
	    driver.findElement(By.cssSelector("button.btn.blue-madison")).click();
		//基础信息
	    //个人资料
